...
namespace Euresys
{
    public class MultiCamException : System.Exception
    {
    ...
    namespace MultiCam
    {
        ...
        public sealed class MC
        {
            ...
            class NativeMethods
            {
                ...
                [DllImport("MultiCam.dll")]
                internal static extern Int32 McConvertSurface(UInt32 inputInstance, UInt32 outputInstance);
            }
            #endregion
            ...
            public const Int32 SURFACESTATE_FILLED = 3;
            ...
            #region Pixel format conversion Method
            public static void ConvertSurface(UInt32 inputInstance, UInt32 outputInstance)
            {
                ThrowOnMultiCamError(NativeMethods.McConvertSurface(inputInstance, outputInstance),
